...
new_prompt="""{
  "task": "Rate a laptop based on the parameters Gaming, Work, Casual, School, Storage Size, Battery Life, Ethernet Port, HDMI Port, Screen Resolution, Keyboard Backlight, Weight, Price, considering the context of Republic of Moldova. You have to give a answer even if you're not very confident in it. You can't change the parameters, answer every and only these paremeters.",
